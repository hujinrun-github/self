...
func writeError(w http.ResponseWriter, err error) {
	...
	case errors.Is(err, ErrInvalidReorder), errors.Is(err, ErrInvalidStatus), errors.Is(err, ErrEmptySlug), errors.Is(err, ErrReservedSlug), errors.Is(err, ErrSlugTooLong), errors.Is(err, ErrSlugConflict), errors.Is(err, ErrUnsafeMarkdownMedia):
