...
CREATE TABLE talks (
  ...
  summary TEXT NOT NULL DEFAULT '',
  cover_media_id BIGINT REFERENCES media_assets(id) ON DELETE RESTRICT,
...
CREATE TABLE project_tech (
  ...
  tech_id BIGINT NOT NULL REFERENCES techs(id) ON DELETE RESTRICT,
  sort_order INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE media_references (
  ...
  created_at TIMESTAMPTZ NOT NULL,
  CONSTRAINT media_references_unique_usage UNIQUE (media_asset_id, resource_type, resource_id, source)
);
