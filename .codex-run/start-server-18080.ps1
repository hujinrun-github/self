...
$env:DATABASE_URL='postgres://postgres:12345@192.168.1.70:19588/postgres?sslmode=disable&options=-c%20search_path%3Dview_0c7aaa3d3950%2Cpublic%20-c%20timezone%3DUTC'
